...
/* ============================================================
   DATA SCHEMA v1 (dayKey joins everything; strain is 0-21)
   ============================================================ */
...
/* ============================================================
   FUEL MODULE
   Weekly plan (protein fixed, carb/fat flex within a capped
   percentage off yesterday's Garmin active energy vs baseline).
   Meal slots assign templates or ad-hoc entries; the shopping
   manifest aggregates template ingredient lines for the week.
   ============================================================ */
...
function showView(id) {
  ...
  window.scrollTo(0, 0);
  if (id === "view-training") { renderWorkoutList(); renderSessionList(); }
